...
/* harmony import */ var _model_films__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../model/films */ "./src/model/films.js");
...
class Api {
  ...
  getFilms() {
    return this._load({url: `movies`})
      .then(Api.toJSON)
      .then((films) => films.map(_model_films__WEBPACK_IMPORTED_MODULE_0__["default"].adaptToClient));
  }
  ...
  updateFilm(film) {
    return this._load({
      url: `movies/${film.id}`,
      method: Method.PUT,
      body: JSON.stringify(_model_films__WEBPACK_IMPORTED_MODULE_0__["default"].adaptToServer(film)),
      headers: new Headers({"Content-Type": `application/json`})
    })
      .then(Api.toJSON)
      .then(_model_films__WEBPACK_IMPORTED_MODULE_0__["default"].adaptToClient);
  }
  ...
  getFilms() {
    if (this._isOnline()) {
      return this._api.getFilms()
        .then((films) => {
          const items = createStoreStructure(films.map(_model_films__WEBPACK_IMPORTED_MODULE_0__["default"].adaptToServer));
    ...
    return Promise.resolve(storeFilms.map(_model_films__WEBPACK_IMPORTED_MODULE_0__["default"].adaptToClient));
  }
  ...
  updateFilm(film) {
    if (this._isOnline()) {
      return this._api.updateFilm(film)
        .then((updatedFilm) => {
          this._store.setItem(updatedFilm.id, _model_films__WEBPACK_IMPORTED_MODULE_0__["default"].adaptToServer(updatedFilm));
          return updatedFilm;
        });
    }

    this._store.setItem(film.id, _model_films__WEBPACK_IMPORTED_MODULE_0__["default"].adaptToServer(Object.assign({}, film)));
...
/*!**********************!*\
  !*** ./src/const.js ***!
  \**********************/
/*! exports provided: BAR_HEIGHT, CARDS_COUNT_PER_STEP, EXTRA_CARDS_COUNT, AUTHORIZATION, END_POINT, STORE_NAME, Mode, SortType, UserAction, UpdateType, FilterType, PageMode, StatisticPeriod, FilmsType */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BAR_HEIGHT", function() { return BAR_HEIGHT; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CARDS_COUNT_PER_STEP", function() { return CARDS_COUNT_PER_STEP; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EXTRA_CARDS_COUNT", function() { return EXTRA_CARDS_COUNT; });
...
const AUTHORIZATION = `Basic dfiufoguhoikhb8746rfdvgc`;
...
/* harmony import */ var _view_films__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./view/films */ "./src/view/films.js");
/* harmony import */ var _view_movies_count__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./view/movies-count */ "./src/view/movies-count.js");
/* harmony import */ var _presenter_film_list__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./presenter/film-list */ "./src/presenter/film-list.js");
/* harmony import */ var _presenter_menu__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./presenter/menu */ "./src/presenter/menu.js");
/* harmony import */ var _presenter_statistics__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./presenter/statistics */ "./src/presenter/statistics.js");
...
/* harmony import */ var _model_films__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./model/films */ "./src/model/films.js");
/* harmony import */ var _model_filter__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./model/filter */ "./src/model/filter.js");
/* harmony import */ var _model_page__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./model/page */ "./src/model/page.js");
/* harmony import */ var _const__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./const */ "./src/const.js");
/* harmony import */ var _utils_render__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./utils/render */ "./src/utils/render.js");
...
const api = new _api_index__WEBPACK_IMPORTED_MODULE_6__["default"](_const__WEBPACK_IMPORTED_MODULE_12__["END_POINT"], _const__WEBPACK_IMPORTED_MODULE_12__["AUTHORIZATION"]);
const store = new _api_store__WEBPACK_IMPORTED_MODULE_7__["default"](_const__WEBPACK_IMPORTED_MODULE_12__["STORE_NAME"], window.localStorage);
const apiWithProvider = new _api_provider__WEBPACK_IMPORTED_MODULE_8__["default"](api, store);
const filmsModel = new _model_films__WEBPACK_IMPORTED_MODULE_9__["default"]();
const filterModel = new _model_filter__WEBPACK_IMPORTED_MODULE_10__["default"]();
const pageModeModel = new _model_page__WEBPACK_IMPORTED_MODULE_11__["default"]();

Object(_utils_render__WEBPACK_IMPORTED_MODULE_13__["render"])(mainElement, new _view_films__WEBPACK_IMPORTED_MODULE_1__["default"]());

const filmsElement = mainElement.querySelector(`.films`);
const filmListPresenter = new _presenter_film_list__WEBPACK_IMPORTED_MODULE_3__["default"](filmsElement, filmsModel, filterModel, apiWithProvider);
const statisticsPresenter = new _presenter_statistics__WEBPACK_IMPORTED_MODULE_5__["default"](mainElement, filmsModel);
const menuPresenter = new _presenter_menu__WEBPACK_IMPORTED_MODULE_4__["default"](mainElement, filterModel, filmsModel, filmListPresenter, statisticsPresenter, pageModeModel);
...
apiWithProvider.getFilms()
  .then((films) => {
    filmsModel.setFilms(_const__WEBPACK_IMPORTED_MODULE_12__["UpdateType"].INIT, films);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_13__["render"])(mainHeaderElement, new _view_user_rank__WEBPACK_IMPORTED_MODULE_0__["default"](films));
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_13__["render"])(footerStatistics, new _view_movies_count__WEBPACK_IMPORTED_MODULE_2__["default"](films.length));
  })
  .catch(() => {
    filmsModel.setFilms(_const__WEBPACK_IMPORTED_MODULE_12__["UpdateType"].INIT, []);
  });
...
class Comments extends _utils_observer__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
    this._comments = [];
  }
...
class Films extends _utils_observer__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
    this._films = [];
  }
...
class Page extends _utils_observer__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
    this._activePageMode = _const__WEBPACK_IMPORTED_MODULE_1__["PageMode"].FILMS;
  }
...
/* harmony import */ var _comment__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./comment */ "./src/presenter/comment.js");
/* harmony import */ var _view_new_comment__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../view/new-comment */ "./src/view/new-comment.js");
/* harmony import */ var _view_comments_wrap__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../view/comments-wrap */ "./src/view/comments-wrap.js");
...
class CommentList {
  ...
  init() {
    this._commentsWrapComponent = new _view_comments_wrap__WEBPACK_IMPORTED_MODULE_2__["default"](this._commentsModel.getComments());
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_4__["render"])(this._commentsContainer, this._commentsWrapComponent);

    this._commentListConteiner = this._commentsWrapComponent.getElement().querySelector(`.film-details__comments-list`);

    this._renderCommentsList();

    this._newCommentComponent = new _view_new_comment__WEBPACK_IMPORTED_MODULE_1__["default"]();
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_4__["render"])(this._commentListConteiner, this._newCommentComponent);
    this._newCommentComponent.setSubmitCommentHandler(this._handleCommentSubmit);
  }

  destroy() {
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_4__["remove"])(this._newCommentComponent);
  ...
  _handleCommentSubmit() {
    ...
    if (!(`emotion` in newComment) || !(`comment` in newComment)) {
      Object(_utils_common__WEBPACK_IMPORTED_MODULE_5__["shakeEffect"])(this._newCommentComponent);
      ...
      this._api.addComment(this._film, newComment)
        .then((response) => {
          this._commentsModel.addComment(_const__WEBPACK_IMPORTED_MODULE_3__["UpdateType"].PATCH_PLUS, response.comments);

          this._changeCommentData(
              _const__WEBPACK_IMPORTED_MODULE_3__["UserAction"].ADD_COMMENT,
              _const__WEBPACK_IMPORTED_MODULE_3__["UpdateType"].PATCH_PLUS,
              this._film,
              {
  ...
  _renderComment(comment) {
    ...
    const commentPresenter = new _comment__WEBPACK_IMPORTED_MODULE_0__["default"](this._commentListConteiner, this._handleCommentDeleteClick);
...
/* harmony import */ var _view_comments__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../view/comments */ "./src/view/comments.js");
...
class Comment {
  ...
  init(comment) {
    this._comment = comment;
    this._commentComponent = new _view_comments__WEBPACK_IMPORTED_MODULE_0__["default"](this._comment);
    this._commentComponent.setCommentDeleteClickHandler(this._handleCommentDeleteClick);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["render"])(this._commentsContainer, this._commentComponent);
  }

  shakeDeletingComment() {
    Object(_utils_common__WEBPACK_IMPORTED_MODULE_3__["shakeEffect"])(this._commentComponent);
  }
  ...
  destroy() {
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["remove"])(this._commentComponent);
  }

  _handleCommentDeleteClick() {
    this._removeData(
        _const__WEBPACK_IMPORTED_MODULE_2__["UserAction"].DELETE_COMMENT,
        _const__WEBPACK_IMPORTED_MODULE_2__["UpdateType"].PATCH_PLUS,
        this._comment
    );
  }
}
...
/* harmony import */ var _view_fimls_container__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../view/fimls-container */ "./src/view/fimls-container.js");
/* harmony import */ var _view_show_more_button__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../view/show-more-button */ "./src/view/show-more-button.js");
/* harmony import */ var _view_most_commented__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../view/most-commented */ "./src/view/most-commented.js");
/* harmony import */ var _view_top_rated__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../view/top-rated */ "./src/view/top-rated.js");
/* harmony import */ var _view_sort__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../view/sort */ "./src/view/sort.js");
/* harmony import */ var _view_no_films__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../view/no-films */ "./src/view/no-films.js");
/* harmony import */ var _view_loading__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../view/loading */ "./src/view/loading.js");
/* harmony import */ var _film__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./film */ "./src/presenter/film.js");
...
/* harmony import */ var _utils_filter__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../utils/filter */ "./src/utils/filter.js");
...
class FilmList {
  constructor(filmsSectionContainer, filmsModel, filterModel, api) {
    ...
    this._api = api;
    this._renderedFilmsCount = _const__WEBPACK_IMPORTED_MODULE_10__["CARDS_COUNT_PER_STEP"];
    this._currentSortType = _const__WEBPACK_IMPORTED_MODULE_10__["SortType"].DEFAULT;
    this._filmPresenter = {};
    this._ratedFilmPresenter = {};
    this._commentedFilmPresenter = {};
    this._isLoading = true;

    this._filmsContainerComponent = new _view_fimls_container__WEBPACK_IMPORTED_MODULE_0__["default"]();
    this._topRatedComponent = new _view_top_rated__WEBPACK_IMPORTED_MODULE_3__["default"]();
    this._mostCommentedComponent = new _view_most_commented__WEBPACK_IMPORTED_MODULE_2__["default"]();
    this._noFilmsComponent = new _view_no_films__WEBPACK_IMPORTED_MODULE_5__["default"]();
    this._loadingComponent = new _view_loading__WEBPACK_IMPORTED_MODULE_6__["default"]();
  ...
  init() {
    ...
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_8__["render"])(this._filmsSectionContainer, this._filmsContainerComponent);
  ...
  destroy() {
    ...
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_8__["remove"])(this._filmsContainerComponent);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_8__["remove"])(this._topRatedComponent);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_8__["remove"])(this._mostCommentedComponent);
  ...
  _renderLoading() {
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_8__["render"])(this._filmsContainerComponent, this._loadingComponent);
  }

  _getFilms() {
    const filterType = this._filterModel.getFilter();
    const films = this._filmsModel.getFilms();
    const filteredFilms = _utils_filter__WEBPACK_IMPORTED_MODULE_11__["filter"][filterType](films);

    switch (this._currentSortType) {
      case _const__WEBPACK_IMPORTED_MODULE_10__["SortType"].DATE:
        return filteredFilms.slice().sort(_utils_common__WEBPACK_IMPORTED_MODULE_9__["sortFilmByDate"]);
      case _const__WEBPACK_IMPORTED_MODULE_10__["SortType"].RATING:
        return filteredFilms.slice().sort(_utils_common__WEBPACK_IMPORTED_MODULE_9__["sortFilmByRating"]);
      default:
  ...
  _getTopRatedFilms() {
    const topRatedFilms = this._filmsModel.getFilms()
      ...
      .sort(_utils_common__WEBPACK_IMPORTED_MODULE_9__["sortFilmByRating"]);

    return topRatedFilms.slice(0, _const__WEBPACK_IMPORTED_MODULE_10__["EXTRA_CARDS_COUNT"]);
  }
  ...
  _renderTopRatedFilmList() {
    ...
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_8__["render"])(this._filmsSectionContainer, this._topRatedComponent);

    this._renderFilms(this._topRatedFilmsListElement, this._filmsTopRated, _const__WEBPACK_IMPORTED_MODULE_10__["FilmsType"].RATED);
  }
  ...
  _getMostCommentedFilms() {
    const mostCommentedFilms = this._filmsModel.getFilms()
      ...
      .sort(_utils_common__WEBPACK_IMPORTED_MODULE_9__["sortFilmByCommentsCount"]);

    return mostCommentedFilms.slice(0, _const__WEBPACK_IMPORTED_MODULE_10__["EXTRA_CARDS_COUNT"]);
  }
  ...
  _renderMostCommentedFilmsList() {
    ...
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_8__["render"])(this._filmsSectionContainer, this._mostCommentedComponent);

    this._renderFilms(this._mostCommentedFilmsListElement, this._filmsMostCommented, _const__WEBPACK_IMPORTED_MODULE_10__["FilmsType"].COMMENTED);
  }
  ...
  _handleViewAction(actionType, updateType, update) {
    switch (actionType) {
      case _const__WEBPACK_IMPORTED_MODULE_10__["UserAction"].UPDATE_FILM_CARD:
      case _const__WEBPACK_IMPORTED_MODULE_10__["UserAction"].ADD_COMMENT:
      case _const__WEBPACK_IMPORTED_MODULE_10__["UserAction"].DELETE_COMMENT:
  ...
  _handleModelEvent(updateType, data) {
    switch (updateType) {
      case _const__WEBPACK_IMPORTED_MODULE_10__["UpdateType"].PATCH:
        this._updateFilms(data);
        break;
      case _const__WEBPACK_IMPORTED_MODULE_10__["UpdateType"].PATCH_PLUS:
        this._updateFilms(data);
      ...
      case _const__WEBPACK_IMPORTED_MODULE_10__["UpdateType"].MINOR:
        ...
        this._renderFilmList();
        break;
      case _const__WEBPACK_IMPORTED_MODULE_10__["UpdateType"].MAJOR:
        this._clearFilmList({resetRenderedFilmsCount: true, resetSortType: true});
        this._renderFilmList();
        break;
      case _const__WEBPACK_IMPORTED_MODULE_10__["UpdateType"].INIT:
  ...
  _renderSort() {
    ...
    this._sortComponent = new _view_sort__WEBPACK_IMPORTED_MODULE_4__["default"](this._currentSortType);
    this._sortComponent.setSortTypeChangeHandler(this._handlerSortTypeChange);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_8__["render"])(this._filmsSectionContainer, this._sortComponent, `before`);
  }

  _renderFilm(container, film, type) {
    const filmPresenter = new _film__WEBPACK_IMPORTED_MODULE_7__["default"](container, this._handleViewAction, this._handleModeChange, this._filmsModel, this._api);
    filmPresenter.init(film);

    switch (type) {
      case _const__WEBPACK_IMPORTED_MODULE_10__["FilmsType"].ALL:
        this._filmPresenter[film.id] = filmPresenter;
        break;
      case _const__WEBPACK_IMPORTED_MODULE_10__["FilmsType"].RATED:
        this._ratedFilmPresenter[film.id] = filmPresenter;
        break;
      case _const__WEBPACK_IMPORTED_MODULE_10__["FilmsType"].COMMENTED:
  ...
  _renderNoFilms() {
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_8__["render"])(this._filmsContainerComponent, this._noFilmsComponent);
  }

  _handlerShowMoreButtonClick() {
    const filmsCount = this._getFilms().length;

    const newRenderedFilmsCount = Math.min(filmsCount, this._renderedFilmsCount + _const__WEBPACK_IMPORTED_MODULE_10__["CARDS_COUNT_PER_STEP"]);
    const films = this._getFilms().slice(this._renderedFilmsCount, newRenderedFilmsCount);

    this._renderFilms(this._filmsListElement, films, _const__WEBPACK_IMPORTED_MODULE_10__["FilmsType"].ALL);
    this._renderedFilmsCount = newRenderedFilmsCount;

    if (this._renderedFilmsCount >= filmsCount) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_8__["remove"])(this._showMoreButtonComponent);
    }
  }
  ...
  _renderShowMoreButton() {
    ...
    this._showMoreButtonComponent = new _view_show_more_button__WEBPACK_IMPORTED_MODULE_1__["default"]();

    this._showMoreButtonComponent.setShowMoreButtonClickHandler(this._handlerShowMoreButtonClick);

    Object(_utils_render__WEBPACK_IMPORTED_MODULE_8__["render"])(this._filmsContainerComponent, this._showMoreButtonComponent);
  }
  ...
  _clearFilmList({resetRenderedFilmsCount = false, resetSortType = false} = {}) {
    ...
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_8__["remove"])(this._noFilmsComponent);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_8__["remove"])(this._showMoreButtonComponent);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_8__["remove"])(this._loadingComponent);
  ...
  _renderFilmList() {
    ...
    this._renderSort();
    this._renderFilms(this._filmsListElement, films.slice(0, Math.min(filmsCount, this._renderedFilmsCount)), _const__WEBPACK_IMPORTED_MODULE_10__["FilmsType"].ALL);
...
/* harmony import */ var _view_film_details__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../view/film-details */ "./src/view/film-details.js");
/* harmony import */ var _view_no_comments__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../view/no-comments */ "./src/view/no-comments.js");
/* harmony import */ var _model_comments__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../model/comments */ "./src/model/comments.js");
/* harmony import */ var _comment_list__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./comment-list */ "./src/presenter/comment-list.js");
...
class Film {
  constructor(filmsListContainer, changeData, changeMode, filmsModel, api) {
    ...
    this._filmsModel = filmsModel;
    this._api = api;
    this._commentsModel = new _model_comments__WEBPACK_IMPORTED_MODULE_3__["default"]();
  ...
  init(film) {
    ...
    this._filmComponent = new _view_film_card__WEBPACK_IMPORTED_MODULE_0__["default"](film);
    this._filmDetalisComponent = new _view_film_details__WEBPACK_IMPORTED_MODULE_1__["default"](film);
    ...
    if (prevFilmComponent === null || !prevFilmDetalisComponent === null) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_5__["render"])(this._filmsListContainer, this._filmComponent);
      return;
    }

    if (this._mode === _const__WEBPACK_IMPORTED_MODULE_6__["Mode"].POPUP && !this._noCommentsComponent) {
      this._initCommentSection();
    }

    if (this._mode === _const__WEBPACK_IMPORTED_MODULE_6__["Mode"].POPUP && !this._commentListPresenter) {
      this._initNoCommentsSection();
    }

    Object(_utils_render__WEBPACK_IMPORTED_MODULE_5__["replace"])(this._filmComponent, prevFilmComponent);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_5__["replace"])(this._filmDetalisComponent, prevFilmDetalisComponent);

    Object(_utils_render__WEBPACK_IMPORTED_MODULE_5__["remove"])(prevFilmComponent);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_5__["remove"])(prevFilmDetalisComponent);
  }

  destroy() {
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_5__["remove"])(this._filmComponent);
  }

  resetView() {
    if (this._mode !== _const__WEBPACK_IMPORTED_MODULE_6__["Mode"].DEFAULT) {
  ...
  _destroyDetailsComponent() {
    ...
    this._changeData(_const__WEBPACK_IMPORTED_MODULE_6__["UserAction"].UPDATE_FILM_CARD, _const__WEBPACK_IMPORTED_MODULE_6__["UpdateType"].PATCH, updateCard);

    Object(_utils_render__WEBPACK_IMPORTED_MODULE_5__["remove"])(this._filmDetalisComponent);
  }

  _openDetailsCard() {
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_5__["render"])(this._popapContainer, this._filmDetalisComponent);
    document.addEventListener(`keydown`, this._escKeyDownHandler);
    this._changeMode();
    this._mode = _const__WEBPACK_IMPORTED_MODULE_6__["Mode"].POPUP;
  ...
  _initNoCommentsSection() {
    this._noCommentsComponent = new _view_no_comments__WEBPACK_IMPORTED_MODULE_2__["default"]();
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_5__["render"])(this._commentsConteiner, this._noCommentsComponent);
  }

  _initCommentSection() {
    this._commentListPresenter = new _comment_list__WEBPACK_IMPORTED_MODULE_4__["default"](this._commentsConteiner, this._film, this._handleCommentListUpdate, this._commentsModel, this._api);
  ...
  _handleAddToWatchListClick() {
    this._changeData(
        _const__WEBPACK_IMPORTED_MODULE_6__["UserAction"].UPDATE_FILM_CARD,
        _const__WEBPACK_IMPORTED_MODULE_6__["UpdateType"].PATCH,
        Object.assign(
            {},
            this._film,
            {
...
class Menu {
  ...
  init() {
    ...
    this._filterComponent = new _view_menu__WEBPACK_IMPORTED_MODULE_0__["default"](filters, this._currentFilter, this._pageMode);
    this._filterComponent.setFilterTypeChangeHandler(this._handleFilterTypeChange);
    this._filterComponent.setStatisticsClickHandler(this._handleStatisticsClick);

    if (prevFilterComponent === null) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["render"])(this._filterContainer, this._filterComponent, `afterbegin`);
      return;
    }
  ...
  _handleStatisticsClick() {
    if (this._pageMode === _const__WEBPACK_IMPORTED_MODULE_3__["PageMode"].FILMS) {
      this._pageMode = _const__WEBPACK_IMPORTED_MODULE_3__["PageMode"].STATISTICS;
      this._statisticsPresenter.init();
      this._filmListPresenter.destroy();
      this._pageModeModel.setMode(_const__WEBPACK_IMPORTED_MODULE_3__["UpdateType"].MAJOR, this._pageMode);
    } else {
      this._pageMode = _const__WEBPACK_IMPORTED_MODULE_3__["PageMode"].FILMS;
  ...
  _getFilters() {
    ...
    return [
      ...
      {
        type: _const__WEBPACK_IMPORTED_MODULE_3__["FilterType"].WATCHLIST,
        name: `Watchlist`,
        count: _utils_filter__WEBPACK_IMPORTED_MODULE_2__["filter"][_const__WEBPACK_IMPORTED_MODULE_3__["FilterType"].WATCHLIST](films).length
      },
      {
        type: _const__WEBPACK_IMPORTED_MODULE_3__["FilterType"].HISTORY,
        name: `History`,
        count: _utils_filter__WEBPACK_IMPORTED_MODULE_2__["filter"][_const__WEBPACK_IMPORTED_MODULE_3__["FilterType"].HISTORY](films).length
      },
      {
        type: _const__WEBPACK_IMPORTED_MODULE_3__["FilterType"].FAVORITES,
        name: `Favorites`,
        count: _utils_filter__WEBPACK_IMPORTED_MODULE_2__["filter"][_const__WEBPACK_IMPORTED_MODULE_3__["FilterType"].FAVORITES](films).length
      }
    ];
  }
}
...
/* harmony import */ var _view_statistics__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../view/statistics */ "./src/view/statistics.js");
/* harmony import */ var _utils_render__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/render */ "./src/utils/render.js");
...
class Statistics {
  ...
  init() {
    this._statisticsComponent = new _view_statistics__WEBPACK_IMPORTED_MODULE_0__["default"](this._filmsModel.getFilms());
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["render"])(this._statisticsContainer, this._statisticsComponent);
    this._statisticsComponent.restoreHandlers();
  }

  destroy() {
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["remove"])(this._statisticsComponent);
  }
}
...
/*!*****************************!*\
  !*** ./src/utils/common.js ***!
  \*****************************/
/*! exports provided: shakeEffect, getCurrentDate, getDurationFormat, getReleaseDate, getCommentDate, getWatchedFilmsCount, getProfileRating, getFilmsDuration, getAllGenres, getTopGenre, sortFilmByDate, sortFilmByRating, sortFilmByCommentsCount */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getDurationFormat", function() { return getDurationFormat; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getWatchedFilmsCount", function() { return getWatchedFilmsCount; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getProfileRating", function() { return getProfileRating; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getFilmsDuration", function() { return getFilmsDuration; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "sortFilmByCommentsCount", function() { return sortFilmByCommentsCount; });
...
const getDurationFormat = (minutes) => {
...
const getReleaseDate = (date, isFullDate = false) => {
  if (isFullDate) {
...
const sortFilmByCommentsCount = (filmA, filmB) => {
...
const render = (container, child, place = `beforeend`) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return CommentsWrap; });
/* harmony import */ var _abstract__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract */ "./src/view/abstract.js");


class CommentsWrap extends _abstract__WEBPACK_IMPORTED_MODULE_0__["default"] {
...
class Comments extends _abstract__WEBPACK_IMPORTED_MODULE_2__["default"] {
  constructor(comment) {
    super();
    this._comment = comment;
  ...
  _createCommentsTemplate() {
    ...
    const commentDate = Object(_utils_common__WEBPACK_IMPORTED_MODULE_1__["getCommentDate"])(new Date(date));
    ...
    return (
      `<li class="film-details__comment" id="${id}">
        ...
        <div>
          <p class="film-details__comment-text">${he__WEBPACK_IMPORTED_MODULE_0___default.a.encode(comment)}</p>
...
class FilmCard extends _abstract__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(film) {
    super();
    this._film = film;
  ...
  _createFilmCardTemplate(film) {
    ...
    const releaseDateTemplate = Object(_utils_common__WEBPACK_IMPORTED_MODULE_1__["getReleaseDate"])(releaseDate);
    const runtimeTemplate = Object(_utils_common__WEBPACK_IMPORTED_MODULE_1__["getDurationFormat"])(runtime);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return FilmDetalis; });
/* harmony import */ var _abstract__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract */ "./src/view/abstract.js");
/* harmony import */ var _utils_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/common */ "./src/utils/common.js");
...
class FilmDetalis extends _abstract__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(film) {
    super();
    this._film = film;
  ...
  _createFilmDetalisPopupTemplate(film) {
    ...
    const releaseDateTemplate = Object(_utils_common__WEBPACK_IMPORTED_MODULE_1__["getReleaseDate"])(releaseDate, true);
...
class Films extends _abstract__WEBPACK_IMPORTED_MODULE_0__["default"] {
  _createFilmsTemplate() {
    return (
  ...
  _createMenuTemplate(filters) {
    ...
    return (
      `<nav class="main-navigation">
        ...
        <a href="#stats" class="main-navigation__additional ${this._pageMode === _const__WEBPACK_IMPORTED_MODULE_1__["PageMode"].STATISTICS ? `main-navigation__additional--active` : ``}">Stats</a>
      </nav>`
    );
  }
...
class MostCommented extends _abstract__WEBPACK_IMPORTED_MODULE_0__["default"] {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return MoviesCount; });
/* harmony import */ var _abstract__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract */ "./src/view/abstract.js");


class MoviesCount extends _abstract__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(count) {
    super();
    this._count = count;
  }
...
class NewComment extends _smart__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(film) {
    super();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return NoComments; });
/* harmony import */ var _abstract__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract */ "./src/view/abstract.js");


class NoComments extends _abstract__WEBPACK_IMPORTED_MODULE_0__["default"] {
...
class NoFilms extends _abstract__WEBPACK_IMPORTED_MODULE_0__["default"] {
...
class ShowMoreButton extends _abstract__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
...
class Sort extends _abstract__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  _createSortTemplate(currentSortType) {
    return (
      `<ul class="sort">
        <li><a href="#" class="sort__button ${currentSortType === _const__WEBPACK_IMPORTED_MODULE_1__["SortType"].DEFAULT ? `sort__button--active` : ``}" data-sort-type="${_const__WEBPACK_IMPORTED_MODULE_1__["SortType"].DEFAULT}">Sort by default</a></li>
        <li><a href="#" class="sort__button ${currentSortType === _const__WEBPACK_IMPORTED_MODULE_1__["SortType"].DATE ? `sort__button--active` : ``}" data-sort-type="${_const__WEBPACK_IMPORTED_MODULE_1__["SortType"].DATE}">Sort by date</a></li>
        <li><a href="#" class="sort__button ${currentSortType === _const__WEBPACK_IMPORTED_MODULE_1__["SortType"].RATING ? `sort__button--active` : ``}" data-sort-type="${_const__WEBPACK_IMPORTED_MODULE_1__["SortType"].RATING}">Sort by rating</a></li>
      </ul>`
    );
  }
...
const renderGenreChart = (statisticCtx, films) => {
  const genres = Object.keys(Object(_utils_common__WEBPACK_IMPORTED_MODULE_4__["getAllGenres"])(films));
  const genresCount = Object.values(Object(_utils_common__WEBPACK_IMPORTED_MODULE_4__["getAllGenres"])(films));
  statisticCtx.height = _const__WEBPACK_IMPORTED_MODULE_5__["BAR_HEIGHT"] * genres.length;
...
class Statistics extends _smart__WEBPACK_IMPORTED_MODULE_1__["default"] {
  constructor(films) {
    super();
    ...
    this._data = {
      ...
      currentPeriod: _const__WEBPACK_IMPORTED_MODULE_5__["StatisticPeriod"].ALL_TIME
    };
  ...
  _createStatisticsTemplate(films, period) {
    ...
    const rankLabel = Object(_utils_common__WEBPACK_IMPORTED_MODULE_4__["getProfileRating"])(films);
    const watchedFilmsCount = Object(_utils_common__WEBPACK_IMPORTED_MODULE_4__["getWatchedFilmsCount"])(watchedFilms);
    const filmsDuration = Object(_utils_common__WEBPACK_IMPORTED_MODULE_4__["getFilmsDuration"])(watchedFilms);
    const totalDurationHours = Math.floor(filmsDuration / 60);
    const totalDurationMinutes = filmsDuration % 60;
    const topGenre = watchedFilms.length > 0 ? Object(_utils_common__WEBPACK_IMPORTED_MODULE_4__["getTopGenre"])(watchedFilms) : ``;
    ...
    return `<section class="statistic">
      ...
      <form action="https://echo.htmlacademy.ru/" method="get" class="statistic__filters">
        ...
        <input type="radio" class="statistic__filters-input visually-hidden" name="statistic-filter" id="statistic-all-time" value="all-time" ${currentPeriod === _const__WEBPACK_IMPORTED_MODULE_5__["StatisticPeriod"].ALL_TIME ? `checked` : ``}>
        <label for="statistic-all-time" class="statistic__filters-label">All time</label>

        <input type="radio" class="statistic__filters-input visually-hidden" name="statistic-filter" id="statistic-today" value="today" ${currentPeriod === _const__WEBPACK_IMPORTED_MODULE_5__["StatisticPeriod"].TODAY ? `checked` : ``}>
        <label for="statistic-today" class="statistic__filters-label">Today</label>

        <input type="radio" class="statistic__filters-input visually-hidden" name="statistic-filter" id="statistic-week" value="week" ${currentPeriod === _const__WEBPACK_IMPORTED_MODULE_5__["StatisticPeriod"].WEEK ? `checked` : ``}>
        <label for="statistic-week" class="statistic__filters-label">Week</label>

        <input type="radio" class="statistic__filters-input visually-hidden" name="statistic-filter" id="statistic-month" value="month" ${currentPeriod === _const__WEBPACK_IMPORTED_MODULE_5__["StatisticPeriod"].MONTH ? `checked` : ``}>
        <label for="statistic-month" class="statistic__filters-label">Month</label>

        <input type="radio" class="statistic__filters-input visually-hidden" name="statistic-filter" id="statistic-year" value="year" ${currentPeriod === _const__WEBPACK_IMPORTED_MODULE_5__["StatisticPeriod"].YEAR ? `checked` : ``}>
  ...
  _periodChangeHandler(evt) {
    if (evt.target.classList.contains(`statistic__filters-input`)) {
      ...
      const dateAWeekAgo = moment__WEBPACK_IMPORTED_MODULE_0___default()().subtract(7, `days`);
      const dateAMonthAgo = moment__WEBPACK_IMPORTED_MODULE_0___default()().subtract(1, `month`);
      const dateAYearAgo = moment__WEBPACK_IMPORTED_MODULE_0___default()().subtract(1, `years`);

      let update;
      switch (evt.target.value) {
        case _const__WEBPACK_IMPORTED_MODULE_5__["StatisticPeriod"].ALL_TIME:
          update = {
            watchedFilms: this._films.filter((film) => film.isWatched),
            currentPeriod: _const__WEBPACK_IMPORTED_MODULE_5__["StatisticPeriod"].ALL_TIME
          };
          break;
        case _const__WEBPACK_IMPORTED_MODULE_5__["StatisticPeriod"].TODAY:
          update = {
            watchedFilms: this._films.filter((film) => film.isWatched && moment__WEBPACK_IMPORTED_MODULE_0___default()(film.watchingDate).isSame(Object(_utils_common__WEBPACK_IMPORTED_MODULE_4__["getCurrentDate"])(), `day`)),
            currentPeriod: _const__WEBPACK_IMPORTED_MODULE_5__["StatisticPeriod"].TODAY
          };
          break;
        case _const__WEBPACK_IMPORTED_MODULE_5__["StatisticPeriod"].WEEK:
          update = {
            watchedFilms: this._films.filter((film) => film.isWatched && moment__WEBPACK_IMPORTED_MODULE_0___default()(film.watchingDate).isBetween(dateAWeekAgo, Object(_utils_common__WEBPACK_IMPORTED_MODULE_4__["getCurrentDate"])())),
            currentPeriod: _const__WEBPACK_IMPORTED_MODULE_5__["StatisticPeriod"].WEEK
          };
          break;
        case _const__WEBPACK_IMPORTED_MODULE_5__["StatisticPeriod"].MONTH:
          update = {
            watchedFilms: this._films.filter((film) => film.isWatched && moment__WEBPACK_IMPORTED_MODULE_0___default()(film.watchingDate).isBetween(dateAMonthAgo, Object(_utils_common__WEBPACK_IMPORTED_MODULE_4__["getCurrentDate"])())),
            currentPeriod: _const__WEBPACK_IMPORTED_MODULE_5__["StatisticPeriod"].MONTH
          };
          break;
        case _const__WEBPACK_IMPORTED_MODULE_5__["StatisticPeriod"].YEAR:
          update = {
            watchedFilms: this._films.filter((film) => film.isWatched && moment__WEBPACK_IMPORTED_MODULE_0___default()(film.watchingDate).isBetween(dateAYearAgo, Object(_utils_common__WEBPACK_IMPORTED_MODULE_4__["getCurrentDate"])())),
            currentPeriod: _const__WEBPACK_IMPORTED_MODULE_5__["StatisticPeriod"].YEAR
          };
          break;
      }
...
class TopRated extends _abstract__WEBPACK_IMPORTED_MODULE_0__["default"] {
...
class UserRank extends _abstract__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  _createUserRankTemplate(filmsCards) {
    const profileRating = Object(_utils_common__WEBPACK_IMPORTED_MODULE_1__["getProfileRating"])(filmsCards);
